# HackCMU — ambient visual learning tool
...
- [docs/WORK_SPLIT.md](docs/WORK_SPLIT.md) — who does what
- [docs/FRD.md](docs/FRD.md) — what it has to do
- [FILESTRUCTURE.md](FILESTRUCTURE.md) — where things go
